...
En las lecturas, actividades del curso y asignaciones de la Unidad 2, explorarás el proceso de evaluación de hipótesis estadísticas. Se te presentarán varios modelos comunes utilizados por investigadores y estadísticos. También utilizarás TinkerPlots&trade; para generar datos simulados para estudiar la variación en los resultados que se esperarían bajo estos modelos. Muchos de estos modelos están directamente relacionados con los modelos de azar que has explorado en el curso hasta este punto. Por ejemplo, ya deberías ser capaz de utilizar TinkerPlots&trade; para producir resultados que se esperarían de 100 lanzamientos de una moneda "justa". 
